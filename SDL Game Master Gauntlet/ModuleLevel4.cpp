...
ModuleLevel4::ModuleLevel4(bool start_enabled) : Module(start_enabled)
{
	background = NULL;
	stars = NULL;
...
bool ModuleLevel4::readmap(){
	...
	myfilemap.open("Gauntlet/lvl4.txt", std::fstream::in);
...
void ModuleLevel4::OnCollision(Collider* c1, Collider* c2)
{
