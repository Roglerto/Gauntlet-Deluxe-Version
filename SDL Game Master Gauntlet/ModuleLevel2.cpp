...
ModuleLevel2::ModuleLevel2(bool start_enabled) : Module(start_enabled)
{
	background = NULL;
	stars = NULL;
...
bool ModuleLevel2::readmap(){
	...
	myfilemap.open("Gauntlet/lvl2.txt", std::fstream::in);
...
update_status ModuleLevel2::PreUpdate(){
...
void ModuleLevel2::OnCollision(Collider* c1, Collider* c2)
{
